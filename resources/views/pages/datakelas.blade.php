...
@section('container')
                            ...
                            <div class="form-row m-2">
                                <div class="col">
                                    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modalcarikelas">Cari Kelas</button>
                                </div>
                                <div class="row">
                                    <div class="col">
    ...
    @foreach ($datakelas as $data1)
        <div class="modal fade" id="editmodal-{{ $data1->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('hapuskelas/' . $data->id) }}" method="POST">
                            ...
                            <input class="form-control" name="guru_id" id="guru_id" type="text" readonly
                                value="{{ $data->guru->id }}" hidden>
                            <input class="form-control" name="kelas_id" id="kelas_id" type="text" readonly
                                value="{{ $data->kelas->id }}" hidden>
                    </div>
    ...
    <!-- MODAL CARI GURU -->
    <div class="modal fade" id="modalcariguru" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <button id="select" data-id="{{ $data->id }}"
                                                    data-nama="{{ $data->nama }}"
                                                    class="btn btn-info btn-sm text-xs mb-0 px-3" data-bs-dismiss="modal">
                                                    PILIH
                                                </button>
                                            </td>
                                        </tr>
    ...
    <!-- MODAL CARI KELAS -->
    <div class="modal fade" id="modalcarikelas" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($namakelas as $data)
                                        <tr>
                                            ...
                                            <td style="text-align: center">{{ $data->nama }}</td>
                                            <td class="align-middle text-center text-sm">
                                                <button id="select2" data-idk="{{ $data->id }}"
                                                    data-namak="{{ $data->nama }}"
                                                    class="btn btn-info btn-sm text-xs mb-0 px-3" data-bs-dismiss="modal">
                                                    PILIH
                                                </button>
                                            </td>
