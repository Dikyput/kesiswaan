...
<button type="button" class="btn btn-sm btn-success m-2" data-bs-toggle="modal" data-bs-target="#modalcarisiswa"> Tambah Mutasi</button>
...
<!-- MODAL CARI SISWA -->
<div class="modal fade" id="modalcarisiswa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                ...
                                <table class="order-hover" id="myTable5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <button id="select" data-id="{{$data->id}}"  data-nis="{{$data->nis}}"  data-nisn="{{$data->nisn}}" data-fullname="{{$data->fullname}}" class="btn btn-info btn-sm text-xs mb-0 px-3">
                                                PILIH
                                            </button>
                                            </td>
                                        </tr>
            ...
            <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input class="form-control border border-dark p-1" name="id" id="id" type="text" aria-label="Isinya" readonly>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">Nama Siswa</label>
                            <input class="form-control border border-dark p-1" name="fullname" id="fullname" type="text" aria-label="Isinya" readonly>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">NIS Siswa</label>
                            <input class="form-control border border-dark p-1" name="nis" id="nis" type="text" aria-label="Isinya" readonly>
                        </div>
                    </div>  
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="example-text-input" class="form-control-label">NISN Siswa</label>
                            <input class="form-control border border-dark p-1" name="nisn" id="nisn"  type="text" aria-label="Isinya" readonly>
                        </div>
                    </div>    
            </div>
                <div class="col">
